...
<footer class="main-footer"> <strong>Copyright &copy; 2018 <a href="#">Easy Trip</a>.</strong> All rights reserved. </footer>
...
$(document).ready(function(){
	setInterval(function(){ $('.hide_one').addClass("hide"); }, 1000);
});
</script>
