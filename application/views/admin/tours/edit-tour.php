...
<section class="content">
  <div class="box box-default box-solid">
    ...
    <div class="box-body" ng-app="tours" ng-controller="createTourContoller">
      ...
      <?php } ?>
      <div class="col-md-9"> <?php echo form_open_multipart(base_url("admin/tours/updateTour"),array("id"=>"frmTourUpdate")); ?>
        <?php foreach($single_tour as $single_tour){ ?>
         ...
         <div class="form-horizontal">
          ...
          <input type="text" name="tour_title" id="tour_title" placeholder="Tour Title" class="form-control" value="<?php echo $single_tour->tour_title; ?>" />
          <span class="tooltips" rel="tooltip" title="Please Enter The Tour Title">?</span> </div>
         <div class="form-horizontal">
          <label>Description: <strong class="text-danger">*</strong></label>
          <input type="text" name="description" id="description" placeholder="Description" class="form-control" value="<?php echo $single_tour->description; ?>" />
         ...
         <div class="form-horizontal">
          ...
          <input type="text" name="operator" id="operator" placeholder="Operator" class="form-control" value="<?php echo $single_tour->operator; ?>"  />
         ...
         <div class="form-horizontal">
          ...
          <input type="text" name="tour_type" id="tour_type" placeholder="Tour Type" class="form-control" value="<?php echo $single_tour->tour_type; ?>" />
         ...
         <div class="form-horizontal">
          ...
          <input type="text" name="start_location" id="start_location" placeholder="Tour Title" class="form-control" value="<?php echo $single_tour->start_location; ?>"  />
         ...
         <div class="form-horizontal">
          ...
          <input type="text" name="end_location" id="end_location" placeholder="End Location" class="form-control" value="<?php echo $single_tour->end_location; ?>" />
         ...
         <div class="form-horizontal">
          ...
          <input type="text" name="start_date" id="start_date" placeholder="Start Date" class="form-control" value="<?php echo $single_tour->start_date; ?>" />
          <span class="tooltips" rel="tooltip" title="Please Enter The Tour End Location">?</span> </div>
         <div class="form-horizontal">
          <label>Tour Duration: <strong class="text-danger">*</strong></label>
          <input type="text" name="tour_duration" id="tour_duration" placeholder="Tour Duration" class="form-control" value="<?php echo $single_tour->tour_duration; ?>" />
         ...
         <div class="form-horizontal">
          ...
          <button class="btn btn-success pull-right button2 btn-flat" type="submit"><i class="fa fa-arrow-right"></i> Update Tour</button>
        </div>
        <input type="hidden" name="tour_id" id="tour_id" value="<?php if(!empty($tourId)){echo $tourId;} ?>" />
        <?php } ?>
